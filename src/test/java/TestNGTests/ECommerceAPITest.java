...
//SSL
        ...
        loginRequest.setUserEmail("soumya.hapi@gmail.com");
        loginRequest.setUserPassword("Dontask123");
        ...
        RequestSpecification reqAddProduct = given().log().all().spec(addProductBaseReq).param("productName", "Laptop")
                ...
                .multiPart("productImage", new File("/Users/H519383/Documents/Develop-Workspace/APIAutomation-RestAssured/src/test/resources/TestData/Laptop.jpeg"));
